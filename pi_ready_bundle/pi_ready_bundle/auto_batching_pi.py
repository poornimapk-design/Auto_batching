...
class AutoBatchingDesktop:
    def __init__(self):
        ...
        self.batch_feed_var = None
        self.batch_current_var = None
        self.batch_expected_var = None
        self.batch_indicator_var = None
        self.batch_current_weight_var = None
    ...
    def _populate_material_table(self, selected_feed=None):
        ...
        formula = get_formula_for_feed(selected_feed) if selected_feed else {}
        for row in motors:
    ...
    def _run_batching_worker(self, selected_feed):
        ...
        self.root.after(0, lambda: self._set_feed_buttons_state('disabled'))
